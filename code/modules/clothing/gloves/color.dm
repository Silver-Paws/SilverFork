...
/obj/item/clothing/gloves/color/latex
	name = "Latex Gloves"
	desc = "Дешёвые стерильные перчатки из латекса. Наночипы, при ношении, дают навык базовой парамедической подготовки о переносе пациентов."
	icon_state = "latex"
	item_state = "lgloves"
...
/obj/item/clothing/gloves/color/latex/nitrile
	name = "nitrile gloves"
	desc = "Стерильные перчатки, более дорогого образца и прочнее латексных. Наночипы, при ношении, дают навык продвинутой парамедической подготовки о переносе пациентов."
	icon_state = "nitrile"
