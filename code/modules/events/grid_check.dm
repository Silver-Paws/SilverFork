...
/datum/round_event/grid_check/announce(fake)
	switch(rand(1, 10))
		...
		if(8 to 10)
			priority_announce("Сегодня на Аванпосту Центрального Командования отмечается праздник «Приведи Своего Отца». В электропитание [station_name()] обнаружено вмешательство. Приносим свои извинения за доставленные неудобства.", "Критический Сбой Питания", 'sound/announcer/classic/poweroff_boomer.ogg')
