...
/obj/item/tank/internals/plasmaman
	...
	desc = "Баллон плазмы, спроектированный для использования как дыхательная система, в частности для плазменных форм жизни. Если вы не Плазмочеловек, вам явно не следует его использовать."
...
/obj/item/tank/internals/emergency_oxygen
	...
	desc = "Для чрезвычайных ситуаций. Содержит малые объёмы кислорода, потому попробуйте сохранить его на случай реальной необходимости."
...
/obj/item/tank/internals/emergency_oxygen/double
	...
	desc = "Сдвоенный баллон кислорода знакомого дизайна. Вмещает почти в два раза больше объёма газа, нежели жёлтый собрат."
