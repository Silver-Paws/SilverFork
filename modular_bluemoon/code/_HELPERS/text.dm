 ...
 *
 * Для "1 и 2" лучше юзать jointext(), если не ожидается пополнение списка в будущем (Новый код, динамический текст).
 * 
 * Здесь указан русский вариант "и", а не "and", для нужд перевода проекта.
 */
