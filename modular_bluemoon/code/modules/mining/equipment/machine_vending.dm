/obj/machinery/mineral/equipment_vendor/Initialize(mapload)
	...
	prize_list += list(//General suggestion to anybody that will use this: keep the lines somewhat same with tabs, not spaces. THANK YOU.
			...
			new /datum/data/mining_equipment("Nanotrasen MRE Ration Kit Menu 1",		/obj/item/storage/box/mre/menu1,		1099,	"Recreational"), //On other forks miners at least can buy themselves some food, at affordable price.
			new /datum/data/mining_equipment("Nanotrasen MRE Ration Kit Menu 2",		/obj/item/storage/box/mre/menu2,		1099,	"Recreational"),
			new /datum/data/mining_equipment("Nanotrasen MRE Ration Kit Menu 3",		/obj/item/storage/box/mre/menu3,		1099,	"Recreational"),
			new /datum/data/mining_equipment("Nanotrasen MRE Ration Kit Menu 4",		/obj/item/storage/box/mre/menu4,		1099,	"Recreational"),
