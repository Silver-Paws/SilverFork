...
/obj/item/reagent_containers/hypospray/medipen/ferrocortex
	...
	desc = "Механоинъектор. На этикетке виден логотип компании Cybersun. Внутри есть доза феррокортекса для стабилизации работников-КПБ в критическом состооянии. Не более одной инъекции за короткое время."
