...
/datum/techweb_node/mws01_basic
	...
	description = "Базовое снаряжение адаптивного оружия MWS-01 в виде батарей и магазина-порта к ним."
...
/datum/techweb_node/mws01_adv
	...
	prereq_ids = list("mws01_basic", "radioactive_weapons", "beam_weapons")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
